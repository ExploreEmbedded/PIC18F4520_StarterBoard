...
void GPIO_PinWrite(gpioPins_et enm_pinNumber, uint8_t var_pinValue_u8)
{
    ...
    case 0:
        util_UpdateBit(LATA,enm_pinNumber,var_pinValue_u8);
        break;
       
        

    case 1:
        util_UpdateBit(LATB,enm_pinNumber,var_pinValue_u8);
        break;
       
        
       
    case 2:
        util_UpdateBit(LATC,enm_pinNumber,var_pinValue_u8);
        break;
        
       
        
    case 3:
        util_UpdateBit(LATD,enm_pinNumber,var_pinValue_u8);
        break;
   


    case 4:
        util_UpdateBit(LATE,enm_pinNumber,var_pinValue_u8);
        break;
